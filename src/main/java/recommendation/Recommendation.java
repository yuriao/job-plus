...
public class Recommendation {
	...
	public List<Item> recommendItems(String userID, double lat, double lon){
		...
		connection.close();
		//Step2, get all favorited itemids
		List<Entry<String, Integer>> keywordList = new ArrayList<>(allKeywords.entrySet());
		Collections.sort(keywordList, (Entry<String, Integer> e1, Entry<String, Integer> e2) -> { // lambda function, anonymous input
			return Integer.compare(e2.getValue(), e1.getValue());// compare the values of two job key words and return unified similarity measure
		});
